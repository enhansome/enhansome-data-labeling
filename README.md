...
* [CVAT](https://github.com/opencv/cvat) ⭐ 16,538 | 🐛 591 | 🌐 Python | 📅 2026-08-17 - Powerful and efficient Computer Vision Annotion Tool
* [labelme](https://github.com/wkentaro/labelme) ⭐ 16,108 | 🐛 163 | 🌐 Python | 📅 2026-08-17 - Image Polygonal Annotation with Python
* [VoTT](https://github.com/microsoft/VoTT) ⚠️ Archived - An open source annotation and labeling tool for image and video assets
* [make-sense](https://github.com/SkalskiP/make-sense) ⭐ 3,559 | 🐛 132 | 🌐 TypeScript | 📅 2024-08-15 - makesense.ai is a free to use online tool for labelling photos
...
* [LOST](https://github.com/l3p-cv/lost) ⭐ 579 | 🐛 15 | 🌐 Python | 📅 2026-08-17 - Design your own smart Image Annotation process in a web-based environment
...
* [wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,376 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-10 - Simple annotations tool, check the example.
...
* [VATIC](https://github.com/cvondrick/vatic) ⭐ 614 | 🐛 91 | 🌐 HTML | 📅 2020-07-15 - VATIC is an online video annotation tool for computer vision research that crowdsources work to Amazon's Mechanical Turk.
...
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,079 | 🐛 924 | 🌐 TypeScript | 📅 2026-08-17 - Label Studio is a configurable data annotation tool that works with different data types
